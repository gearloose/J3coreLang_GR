...
/**
 * The superclass of all Lang Builder parts. The "parts" are intelligent stateful
 ...
 */
abstract class LbAbstractPart extends LbAbstractObject
{
	/**
	 ...
	 * engine part.
	 */
	final public function setup(&$parametersArray = array())
	{
		if ($this->isPrepared)
		{
